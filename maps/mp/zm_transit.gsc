...
custom_add_weapons()
{
    ...
    if ( isdefined( level.raygun2_included ) && level.raygun2_included )
        add_zombie_weapon( "raygun_mark2_zm", "raygun_mark2_upgraded_zm", &"ZOMBIE_WEAPON_RAYGUN_MARK2", 10, "raygun_mark2", "", undefined );

    /*
        New weapons.

        add_zombie_weapon( "weaponname_zm", "weaponname_upgraded_zm", &"ZOMBIE_WEAPON_WEAPONNAME", price, "soundname", "", undefined, 1 );
    ...
    */
    ...
    add_zombie_weapon( "scar_zm", "scar_upgraded_zm", &"ZOMBIE_WEAPON_SCAR", 50, "wpck_rifle", "", undefined, 1 );
    add_zombie_weapon( "evoskorpion_zm", "evoskorpion_upgraded_zm", &"ZOMBIE_WEAPON_EVOSCORPION", 50, "wpck_rifle", "", undefined, 1 );
    add_zombie_weapon( "mg08_zm", "mg08_upgraded_zm", &"ZOMBIE_WEAPON_MG08", 50, "wpck_rifle", "", undefined, 1 );
    add_zombie_weapon( "mp40_zm", "mp40_upgraded_zm", &"ZOMBIE_WEAPON_MP40", 50, "wpck_rifle", "", undefined, 1 );
    add_zombie_weapon( "mp40_stalker_zm", "mp40_stalker_upgraded_zm", &"ZOMBIE_WEAPON_MP40", 50, "wpck_rifle", "", undefined, 1 );
    add_zombie_weapon( "mp44_zm", "mp44_upgraded_zm", &"ZOMBIE_WEAPON_MP44", 50, "wpck_rifle", "", undefined, 1 );
    add_zombie_weapon( "pdw57_zm", "pdw57_upgraded_zm", &"ZOMBIE_WEAPON_PDW57", 50, "wpck_rifle", "", undefined, 1 );
    add_zombie_weapon( "ballista_zm", "ballista_upgraded_zm", &"ZOMBIE_WEAPON_BALLISTA", 50, "wpck_rifle", "", undefined, 1 );
    add_zombie_weapon( "ksg_zm", "ksg_upgraded_zm", &"ZOMBIE_WEAPON_KSG", 50, "wpck_rifle", "", undefined, 1 );
    add_zombie_weapon( "c96_zm", "c96_upgraded_zm", &"ZOMBIE_WEAPON_C96", 50, "wpck_rifle", "", undefined, 1 );
    add_zombie_weapon( "thompson_zm", "thompson_upgraded_zm", &"ZOMBIE_WEAPON_THOMPSON", 50, "wpck_rifle", "", undefined, 1 );
}
